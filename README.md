...
| ⚙️ **LLM Automation** | LLM API workflows with error handling, retries, and monitoring |
| 🎙️ **Multimodal AI** | Speech-to-Text (STT), Text-to-Speech (TTS), and multimodal AI application development |
